...
(function () {
    ...
    ui.Pages.define(searchPageURI, {
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "Swiateczna ksiazka kucharska";
                document.querySelector(".titlearea .pagesubtitle").textContent = "Wyniki dla“" + this._lastSearch + '”';
            }
        },
    ...
    appModel.Search.SearchPane.getForCurrentView().onsuggestionsrequested = function (eventObject) {
        ...
        var terms = ["sól", "marchew", "jajo", "cukier", "cebula", "woda", "olej"];
